<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
    ...
    <main class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
      ...
      <!-- Universal Filters Demo -->
      <div v-if="activeTab === 'universal-filters-demo'">
        <UniversalFiltersDemo />
      </div>
    </main>
...
import UniversalFilterSystem from './components/UniversalFilterSystem.vue'
import { useUniversalFilters } from './composables/useUniversalFilters'
...
const tabs = [
  ...
  { id: 'universal-filters-demo', name: 'Universal Filters Demo', icon: AdjustmentsHorizontalIcon, adminOnly: true }
]
