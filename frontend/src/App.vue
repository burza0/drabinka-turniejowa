      ...
      <div class="hidden sm:block max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-4">
        <div class="flex justify-center">
          <div class="relative w-full max-w-2xl">
            ...
            <input 
              type="text" 
              class="block w-full pl-10 pr-3 py-3 border border-gray-300 dark:border-gray-600 rounded-lg leading-5 bg-white dark:bg-gray-700 placeholder-gray-500 dark:placeholder-gray-400 text-gray-900 dark:text-white focus:outline-none focus:placeholder-gray-400 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-base transition-colors duration-200 shadow-sm"
              placeholder="Szukaj zawodników..."
              v-model="searchTerm"
            />
          </div>
